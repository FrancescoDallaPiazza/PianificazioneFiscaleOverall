...
> canale dividendo (§ 4.3) e la raccomandazione sul concordato preventivo (§ 6). Erano i
> due punti su cui la versione 1 chiedeva di decidere. Il dettaglio degli errori e i
> conti rifatti stanno in `99-verifiche/V02-verifica-diagnosi.md`.

---

## 1. Il gruppo in una pagina

**[A]** Non è un gruppo. È **una sola società**: nessuna controllata, nessuna
partecipazione, nessuna entità estera. Il nome "Group" è commerciale.

| | |
|---|---|
| Forma | S.r.l., capitale € 10.000 i.v., costituita 15/01/2018 |
| Sede | Villafranca di Verona (VR), fraz. Dossobuono |
| ATECO | 74.99.21 — consulenza sicurezza e igiene dei posti di lavoro |
| Oggetto | sicurezza sul lavoro, ambiente e rifiuti, HACCP, privacy, 231, marcatura CE, formazione, sorveglianza sanitaria, autotrasporto |
| Bilancio | micro-impresa ex art. 2435-*ter* c.c. |
| Organo | CdA di 4 membri, tutti soci, nominati 15/01/2018 a tempo indeterminato |
| Controllo | nessun sindaco né revisore |

**[A] Quattro soci al 25% esatto, che sono anche i quattro amministratori.**

| Socio | Quota | Carica | Residenza |
|---|---|---|---|
| Pradella Tazio (1985) | 25% | Presidente CdA, rappresentante | Verona |
| Dalla Piazza Francesco (1971) | 25% | Vice Presidente | Padova |
| Maggia Marco (1964) | 25% | Consigliere | Villafranca di Verona |
| Dall'Oca Marco (1960) | 25% | Consigliere | Villafranca di Verona |

**[A]** Personale 2026: tre dipendenti (Stelluti Erika, Vedova Martina, Carli Anna —
assunta a luglio 2026) più il Presidente Pradella, a cedolino come **co.co.co.**

**[V] Correzione a un'affermazione della versione 1.** «Non è un gruppo» valeva per la
*società*: la visura attesta che Overall Group non detiene partecipazioni. Non dice nulla
sui **soci**, e nel fascicolo ci sono due indizi che meritano una domanda diretta:
il domicilio digitale di Dall'Oca rinvia a un'azienda agricola, e a Pradella è trattenuto
in busta paga esattamente l'8,00% — un terzo del 24% — **prova che è già iscritto a
un'altra gestione previdenziale obbligatoria o è titolare di pensione**. Vanno mappate le
altre attività dei quattro soci: incidono sulle aliquote marginali, quindi su tutto il § 4.3.

**Il rischio non fiscale che vale più di tutti.** Quattro soci al 25% esatto: nessuna
decisione può essere presa contro uno qualsiasi di loro. Finché c'è accordo funziona; il
giorno in cui due si dividono dagli altri due la società è in stallo e l'unica uscita è
lo scioglimento. Va aggiunto che questo è anche un vincolo fiscale: **ogni leva discussa
in questo documento richiede l'unanimità dei quattro**, e alcune (una politica di
distribuzione pluriennale, l'adesione al concordato) vincolano per due esercizi.

---

## 2. I numeri

**[A]** Valori in euro, ricostruiti per quadratura dai bilanci XBRL depositati.
...
| **Tax rate effettivo** | 23,8% | 28,9% | 34,9% | **13,9%** |
| Compensi amministratori (nota) | n.d. | 43.882 | **45.652** | 47.893 |

**Stato patrimoniale al 31/12/2025 [A]:**

| Attivo | | Passivo | |
|---|---:|---|---:|
| Immobilizzazioni materiali | 13.788 | Capitale | 10.000 |
| Crediti (entro l'esercizio) | 152.349 | Riserva legale | 2.000 |
| Disponibilità liquide | 150.925 | **Altre riserve** (riserva straordinaria) | 144.006 |
| Ratei e risconti | 3.499 | Utile d'esercizio | 106.107 |
| | | **Patrimonio netto** | **262.113** |
| | | Fondi per rischi e oneri | **0** |
| | | TFR lavoro subordinato | **855** |
| | | Debiti (entro l'esercizio) | 57.023 |
| | | Ratei e risconti | 570 |
| **Totale** | **320.561** | **Totale** | **320.561** |

**Il 2025 è un anno di rottura.** Ricavi +39,4%, costi +16,9%: la leva operativa ha
raddoppiato il margine, EBIT margin dal 15,7% al 29,2%. Il driver è l'incidenza dei costi
per servizi, scesa dal 58,1% al 48,2% del valore della produzione.

**La società è ipercapitalizzata e senza debito finanziario.** Patrimonio netto all'82%
dell'attivo, 57.023 di debiti tutti operativi, zero banche, 150.925 di liquidità.

**Nessun immobile e nessun bene immateriale iscritto.** Questo esclude in partenza tutta
la famiglia di leve legate al patrimonio immobiliare — assegnazione agevolata compresa,
la cui finestra scade il 30 settembre e che qui **non serve**.

> **[A] Una segnalazione che non riguarda le imposte ma va fatta.** L'Executive Summary
> predisposto per il CdA riporta per lo stesso esercizio 2025 **utile 105.270**, patrimonio
> netto 261.276, debiti 57.860 e imposte 18.027. Il bilancio depositato dice 106.107,
> 262.113, 57.023 e 17.190. Sono i numeri di una bozza precedente, sfasati di 837 euro
> sulle imposte. **Due documenti societari con utili diversi per lo stesso esercizio sono
> un problema in sede di accesso**: va allineato o ritirato, e comunque datato come bozza.

---

## 3. L'anomalia: il tax rate 2025 crolla al 13,9% mentre l'utile raddoppia

**[A]** Il risultato ante imposte passa da 47.448 a 123.297 (+160%); le imposte correnti
da 16.543 a 17.190 (+3,9%).

**[A] Non lo sa nemmeno il CdA.** L'Executive Summary interno elenca il basso tax rate fra
le "aree di attenzione" e scrive: *«Da verificare con il consulente fiscale: eventuali
crediti d'imposta utilizzati, agevolazione ACE, sopravvenienze attive non tassabili o
altre componenti che giustificano la differenza. Tema su cui il CdA potrebbe ricevere
domande.»* La domanda è aperta dentro la società, non solo per noi.

**[I] La spiegazione è il concordato preventivo biennale.** Sotto CPB l'imponibile IRES e
il valore della produzione netta IRAP sono quelli *concordati*: l'utile eccedente non è
tassato. Il profilo osservato è esattamente quello — un 2024 con tax rate sopra la media
(34,9%, coerente con un concordato superiore all'effettivo) seguito da un 2025 in cui
l'utile esplode e l'imposta resta ferma.

Le spiegazioni alternative indicate dall'Executive Summary sono state esaminate e
scartate: l'**ACE** è abrogata dal 2024; **crediti d'imposta** e **sopravvenienze non
tassabili** avrebbero lasciato traccia in bilancio e non sono compatibili con
l'andamento 2024; l'**IRES premiale** fallisce due condizioni su quattro (la società ha
distribuito il 37,7% dell'utile 2025 contro l'obbligo di accantonarne l'80%, e non ha
investimenti 4.0/5.0); la **super-deduzione nuove assunzioni** non ha capienza (l'unica
assunzione è di luglio 2026, quindi non incide sul 2025).

**Riscontro documentale forte [A]:** il socio Dalla Piazza Francesco **ha aderito al CPB**
come lavoratore autonomo per il 2024.

| Voce del quadro CP | Importo |
|---|---:|
| Reddito professionale **effettivo** 2024 (CP10 col. 3) | 118.111 |
| Reddito **concordato** 2024 (CP2 col. 1) | 89.149 |
| Reddito ante CPB rettificato (CP2 col. 2) | 87.318 |
| Incremento assoggettato a sostitutiva 10% (CP2 col. 3-5) | 1.831 → **183** di imposta |
| Reddito complessivo effettivo (CP10 col. 6) | 131.816 |

**28.962 euro di reddito professionale effettivo non hanno scontato alcuna imposta**
(118.111 − 89.149); altri 1.831 hanno scontato il 10% invece dell'aliquota marginale. Il
risparmio del solo socio Dalla Piazza nel solo 2024 è nell'ordine di **13.000 euro**.
...
> Va acquisito il **modello Redditi SC 2025 e 2026 con i quadri P e CP** e la
> dichiarazione IRAP, per rispondere a due cose:
> 1. **La società ha davvero aderito al CPB, e con quali importi?**
> 2. **Per quale biennio: 2024-2025 o 2025-2026?** Se 2024-2025, il concordato è scaduto
>    con l'esercizio 2025, il 2026 è già a tassazione ordinaria e bisogna decidere entro
>    il 2 novembre. Se 2025-2026, la società è ancora coperta per il 2026 e la finestra
>    utile è quella del 2027-2028. Il pattern dei tax rate è compatibile con entrambe.

---

## 4. Come esce la cassa, e a quale costo

### 4.1 Gli utili si accumulano

**[A]** Destinazione degli utili deliberata:

| Esercizio | Utile | A riserva | Distribuito |
|---|---:|---:|---:|
| 2023 | 39.048 | 39.048 | **0** |
| 2024 | 30.905 | 30.905 | **0** |
| 2025 | 106.107 | 66.107 | **40.000** (10.000 a socio, entro 30/06/2026) |

**[A]** Dopo la delibera del 30 aprile 2026 le riserve di utili disponibili valgono
**210.113 euro** (144.006 di riserva straordinaria + 66.107 dell'esercizio 2025), oltre ai
2.000 di riserva legale indisponibili. Distribuirle integralmente costa **54.629 euro di
ritenuta del 26%**: 155.484 netti ai soci, **38.871 a testa**.

**Il vincolo è di cassa, ma è meno rigido di quanto sembri.** Al 31/12/2025 la liquidità
era 150.925; dedotti i 40.000 in uscita entro giugno restano circa 111.000, contro
210.113 di riserve. Ma la società **autofinanzia circa 50.000 euro l'anno** (la liquidità
è cresciuta di 50.183 nel 2025 pur avendo assorbito 65.630 di maggiori crediti): la
distribuzione integrale non è impossibile, è **una politica pluriennale da deliberare**,
non un ostacolo strutturale.

**[A]** I crediti sono passati da 86.719 a 152.349 (+76%), il doppio della crescita dei
ricavi. Il DSO effettivo è di **circa 108 giorni** (i crediti sono lordi IVA, i ricavi
netti: il calcolo diretto 152.349/421.299 × 365 = 132 giorni sovrastima). In peggioramento
rispetto ai ~87 giorni del 2024. **[V]** Il bilancio micro non dettaglia la voce: va
verificato che siano davvero crediti verso clienti e non anche crediti tributari o verso
soci.

C'è un **disallineamento tra l'obiettivo dichiarato e il comportamento storico**: per tre
esercizi su quattro la società ha trattenuto tutto. Se l'obiettivo è portare cassa ai
soci, il primo intervento non è fiscale — è una politica di distribuzione deliberata. Lo
dice anche l'Executive Summary al CdA: *«Il CdA dovrebbe esprimere una posizione
esplicita.»*

### 4.2 Il canale fattura

**[A]** I costi per servizi valgono **203.509 euro nel 2025**, il 48,2% del valore della
produzione (erano il 58,1% nel 2024).

**[A]** Il socio Dalla Piazza ha fatturato nel 2024 **128.313 euro** di compensi
professionali (quadro RE, codice attività **702002 — consulenza gestionale**), con
ritenute d'acconto per 25.663, esattamente il 20%: tutti i suoi committenti sono sostituti
d'imposta.

**[V] Attenzione: non è dimostrato che i quattro soci fatturino il 48% dei ricavi**, e i
numeri disponibili vanno in direzione opposta. Nel 2024 il solo Dalla Piazza ha fatturato
128.313 su un B7 di 176.141: se anche gli altri tre fatturassero in proporzione, il B7
non basterebbe. E nel 2025 i ricavi crescono del 39,4% mentre il B7 cresce del 15,5% —
segno che il B7 contiene una quota rilevante di costi non riferibili ai soci. **Serve il
dettaglio del B7 2025 per soggetto**: senza, il § 4.3 resta un modello e non una
raccomandazione.

### 4.3 Quanto costa far arrivare un euro netto al socio — modello rivisto

> ⚠️ **Questo paragrafo sostituisce integralmente quello della versione 1, che era
> sbagliato nel metodo.** Confrontava il canale fattura al netto dello scudo fiscale e il
> canale dividendo al lordo: due metriche diverse sulle due alternative dello stesso
> confronto, con il risultato predeterminato dalla scelta del denominatore.

**La metrica corretta.** Il confronto si fa su **un euro di reddito ante imposte della
società**, identico nelle due colonne. Se la società paga una fattura F al socio, il
reddito ante imposte è M − F; se non la paga e distribuisce, è M e si distribuisce
(1 − t) · F. **In entrambi i casi la società trattiene lo stesso importo.** Il confronto è
quindi puro e riguarda solo quanto arriva al socio.

**Parametri 2026 verificati.** IRES 24% · IRAP Veneto **4,08%** (3,90 + 0,18, L.R. Veneto
32/2024), prelievo societario combinato **28,08%** · ritenuta dividendi 26% · IRPEF
**23% fino a 28.000, 33% da 28.000 a 50.000, 43% oltre** (la seconda aliquota è scesa dal
35% al 33% con l'art. 1, c. 3, L. 199/2025) · Inarcassa soggettivo 14,5% deducibile, con
**massimale reddituale 147.300 oltre il quale non è più dovuto**, integrativo 4% ripetibile
sul committente · gestione separata INPS 26,07% per i professionisti, 35,03% per i
co.co.co., **24% per chi è già iscritto ad altra gestione**.

**Costo per euro netto in tasca al socio:**

| Scenario | Fattura | Dividendo | Compenso amministratore | Vince |
|---|---:|---:|---:|---|
| Ordinario, marginale 25% | 1,62 | 1,88 | 2,29 | **fattura** |
| Ordinario, marginale 35% | 1,87 | 1,88 | ~2,40 | parità |
...
1. **Fuori dal CPB non vince la fattura: vince il dividendo**, per un socio nel terzo
   scaglione. La soglia di indifferenza è un'aliquota marginale complessiva di circa il
...
assimilato a lavoro dipendente e non rientra nel reddito concordato del socio. Ma va letto
insieme al § 5.1: **i compensi di amministratore sono il presidio che distingue l'attività
gestoria dalla prestazione tecnica.** Comprimerli per ragioni fiscali indebolisce la
difesa. Il trade-off va deciso dai soci, non risolto d'ufficio. Si ricorda che sono
deducibili **per cassa** (art. 95, c. 5, TUIR).

**Cinque limiti che accompagnano lo scenario migliore (entrambi in CPB), e non sono
opzionali:**

1. **Capienza.** Il vantaggio esiste solo finché il reddito effettivo resta sopra il
   concordato, su entrambi i lati. Se la proposta 2026-2027 fosse ancorata al reddito
   effettivo 2025 (§ 6), la capienza sul lato società potrebbe essere prossima a zero e
   **lo scenario non si aprirebbe affatto**.
2. **Comprimere il reddito con fatture non fa cessare il concordato**: la cessazione per
   crollo del reddito richiede circostanze eccezionali da decreto MEF e uno scostamento
   oltre il 30% (art. 19, c. 2). Sotto quella soglia si produce **perdita secca**, perché
   l'imposta resta dovuta sul concordato.
3. **Effetto sul biennio successivo:** il maggior reddito del socio alza la base della
   proposta 2028-2029.
...
## 5. Aree di rischio, lette con l'occhio di chi verifica

### 5.1 Il perimetro fattura-socio / compenso-amministratore — GIALLO

**[A]** Quattro soci che sono i quattro amministratori, che fatturano alla propria società
prestazioni tecniche, mentre i compensi di amministratore valgono 47.893 (≈ 12.000 a testa).

> **[A] Correzione a un argomento della versione 1, che era rovesciato.** La versione 1
> presentava come elemento favorevole il fatto che «per gli ingegneri l'incarico di
> amministratore non rientra nell'oggetto della professione». **La prassi dice il
> contrario proprio per questa società.** La circolare AdE **n. 105/E del 12 dicembre
> 2001** — che ha superato la n. 67/E dello stesso anno — fissa **due criteri
> alternativi**: la previsione espressa dell'ordinamento professionale *oppure* la
> **connessione oggettiva** fra l'attività della società e le mansioni tipiche della
> professione. E porta come esempio testuale *«l'ingegnere edile che sia membro del
> consiglio di amministrazione di una società di ingegneria o di una società che opera nel
> settore delle costruzioni»*. Overall Group fa consulenza tecnica su sicurezza,
> antincendio, direttiva macchine e marcatura CE: la connessione oggettiva opera in pieno.
> **Lo scudo non c'è.**

I tre rilievi che un verificatore muove:

1. **Sovrapposizione delle funzioni.** Se l'attività fatturata coincide con quella di
   amministratore, la fattura viene riqualificata. E per effetto della circolare 105/E i
   due redditi appartengono, per gli amministratori-professionisti con attività connessa,
   alla **stessa categoria reddituale**: la distinzione è più debole di quanto la versione
   1 lasciava intendere.
2. **Congruità.** Non è motivo autonomo di ripresa — è indice sintomatico del difetto di
   inerenza, e l'onere di provare la macroscopica irragionevolezza resta sull'ufficio. Ma
   è l'indice che innesca il controllo.
3. **[V] L'inquadramento di Pradella va risolto, non spiegato.** Il Presidente è co.co.co.
   a cedolino mentre gli altri fatturano. Se anche lui è professionista con attività
   connessa, il cedolino **non è l'inquadramento corretto**. Servono le qualifiche
   professionali dei quattro: agli atti c'è solo quella di Dalla Piazza (PEC del dominio
   dell'Ordine degli Ingegneri).
   **[A] Nota collegata:** il codice attività 702002 dichiarato da Dalla Piazza è di
   *consulenza imprenditoriale e gestionale*, non di studio di ingegneria. Davanti a un
   verificatore è il primo elemento che rende difficile sostenere che amministrare una
   società sia estraneo al proprio oggetto professionale.

**La difesa reale non è la separazione delle categorie reddituali: è la separazione delle
prestazioni.** Serve, *prima* e non dopo: contratti scritti con data certa fra ciascun
socio e la società che descrivano una prestazione tecnica determinata; evidenza
dell'esecuzione (relazioni, rapporti di intervento, timesheet); un corrispettivo ancorato
a tariffe di mercato. È l'unica difesa disponibile, non un rafforzativo.

### 5.2 Il "trattamento di quiescenza" — GIALLO

**[A]** Il conto economico espone alla voce B9-d "trattamento di quiescenza e simili"
3.500 nel 2023, 3.500 nel 2024 e 3.495 nel 2025 — **11.263 euro dedotti in tre esercizi**.
Ma i fondi per rischi e oneri a passivo sono **zero** e l'unica posta è il TFR da 855 euro,
riferibile ai dipendenti. **Tre anni di accantonamenti non hanno prodotto alcun fondo.**

**[I]** La lettura più probabile è che siano premi di una **polizza TFM**. **[V]** Va
verificato, perché le conseguenze divergono.

**La regola, citata correttamente.** *(La versione 1 attribuiva il requisito all'art. 105,
c. 4, TUIR: è sbagliato.)* L'art. 105, c. 4, si limita a estendere i commi 1 e 2 agli
accantonamenti per le indennità di fine rapporto dell'art. 17, c. 1, lett. c), d) e f). **Il
requisito sta nell'art. 17, c. 1, lett. c) TUIR**, che richiede che il diritto all'indennità
risulti da **atto di data certa anteriore all'inizio del rapporto**. La deducibilità per
competenza discende dal combinato disposto.

**[A] E c'è già un problema nel fascicolo:** la clausola TFM sta nell'**art. 24 dello
statuto**, cioè in un atto di data certa anteriore — ma la giurisprudenza consolidata
richiede che l'atto **specifichi anche l'importo o il criterio di determinazione**
(Cass. n. 19571/2022; conformi nn. 19445/2023, 15966/2024, 4487/2025, 16354/2025,
18026/2025; isolata in senso contrario Cass. n. 3788/2023). Una clausola statutaria
generica non basta. **Posta in gioco: 11.263 euro dedotti, circa 2.700 di IRES**, più
sanzioni.

**Documenti:** delibera assembleare istitutiva del TFM con importo o criterio e prova della
data certa; eventuale polizza, con l'indicazione di chi è contraente e beneficiario.

### 5.3 L'IVA — l'imposta di cui la versione 1 non parlava affatto

È l'imposta su cui si fanno più verifiche, e qui ci sono quattro fronti aperti.

1. **[V] Formazione ed esenzione.** L'oggetto sociale comprende formazione e formazione
   obbligatoria. Se una quota dei ricavi è esente ex art. 10, n. 20, DPR 633/1972, scatta
   il **pro-rata di detraibilità**. Va verificato come è trattata oggi.
2. **[V] Intermediazione di rifiuti.** L'oggetto sociale comprende intermediazione di
   rifiuti «sia con detenzione e non», e la visura riporta iscrizioni ad albi e registri
   ambientali. Va accertata l'iscrizione all'**Albo Gestori Ambientali** e il regime IVA
   applicato alle relative operazioni, incluso l'eventuale reverse charge.
3. **[A] Il concordato non copre l'IVA.** L'art. 18 D.Lgs. 13/2024 lo dice
   espressamente: gli effetti del CPB non si producono ai fini IVA. Sotto concordato la
   **discrasia fra reddito dichiarato e volume d'affari cresce**, ed è un indicatore di
   selezione. Chi aderisce deve aspettarsi che il controllo si sposti sull'IVA.
4. **[A] Adempimento immediato.** I 40.000 euro di dividendi deliberati e pagati entro il
   30/06/2026 comportano **10.400 euro di ritenuta del 26%** da versare (art. 27, c. 1,
   DPR 600/1973) e da esporre nel modello 770. Va confermato che sia stato fatto.

### 5.4 Il canone di godimento beni di terzi — da chiarire

**[A]** La voce B8 vale 13.032 nel 2025 e 14.927 nel 2024. La versione 1 concludeva che
«beni ai soci in godimento non emergono dal bilancio»: **emergono, ed è questa la voce**.
**[V]** Va accertato chi è il locatore della sede di Via Alessandro Volta 36 — se è un
socio o una società a lui riconducibile, si apre il tema della congruità del canone e,
in ipotesi, dell'art. 67, c. 1, lett. h-*ter*), TUIR. Stessa verifica per i noleggi auto.
...
- **Esterovestizione, CFC, transfer pricing:** non applicabili. Nessuna entità estera. La
  norma sui prezzi di trasferimento (art. 110, c. 7, TUIR) non si applica fra soggetti
  residenti (art. 5, c. 2, D.Lgs. 147/2015, interpretazione autentica): fra soci e società
  il terreno è l'art. 9 TUIR combinato con inerenza e antieconomicità.
- **Società di comodo:** il test di legge (L. 724/1994) è patrimoniale, non reddituale —
  si confrontano i ricavi effettivi con quelli presunti sugli asset. Con 13.788 di
  immobilizzazioni e 421.299 di ricavi il test è ampiamente superato. Non rileva neppure la
  disciplina delle società in perdita sistematica.
- **Collegio sindacale / revisore:** non obbligatori. Le soglie dell'art. 2477 c.c. sono
  4 milioni di attivo, 4 milioni di ricavi, 20 dipendenti, da superare per due esercizi
  consecutivi. La società è a 320.561, 421.299 e 4 addetti: **anche crescendo del 39%
  l'anno servirebbero sei anni** per avvicinare la soglia dei ricavi.
...
| 8 | **Delibera TFM** con importo o criterio e prova della data certa; eventuale polizza | Chiude il § 5.2, dove ci sono 11.263 euro dedotti |
| 9 | **Contratti fra soci e società**, se esistono | Chiude il § 5.1 ed è il presidio contro la decadenza del § 5.5 |
| 10 | **Composizione del B7, del B8 e dei crediti**; chi è il locatore della sede | §§ 4.1, 5.4 |
| 11 | **Dichiarazioni IVA 2024-2025**, trattamento della formazione, iscrizione Albo Gestori Ambientali | § 5.3 |
| 12 | **Verifiche, avvisi, contenziosi, rateazioni** in corso | Il debito tributario oltre 5.000 euro è causa di esclusione dal CPB |
| 13 | **770/2026** e prova del versamento della ritenuta sui dividendi | § 5.3, punto 4 |

---

## 8. Le quattro righe che contano

1. **La società è sana, liquida e senza debito, e ha 210.113 euro di riserve che i soci non
   hanno mai incassato.** Il freno non è fiscale: è l'assenza di una politica di
   distribuzione. La cassa per farlo si genera in circa quattro anni di autofinanziamento.
